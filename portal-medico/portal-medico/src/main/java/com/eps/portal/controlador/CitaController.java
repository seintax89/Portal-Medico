...
import com.eps.portal.modelo.service.CitaService;
...
public class CitaController {
    ...
    // Solo Pacientes o MÃ©dicos logueados pueden crear citas
    @PostMapping
    ...
    public ResponseEntity<?> agendarCita(@Valid @RequestBody CitaRequest request, Authentication authentication) {
        try {
            // Extraemos el rol del usuario que estÃ¡ haciendo la peticiÃ³n desde el Token JWT
            ...
            // Manejo bÃ¡sico de errores (Fase 11 inicial): Devolvemos un HTTP 400 con el mensaje de la regla rota
    ...
    public ResponseEntity<java.util.List<CitaResponse>> obtenerMisCitas(Authentication authentication) {
        // authentication.getName() devuelve el email del usuario logueado segÃºn UserDetailsServiceImpl
