...
public interface CitaRepository extends JpaRepository<Cita, Long> {
    ...
    // Regla de Negocio RN-03: Â¿El mÃ©dico ya tiene una cita exacta a esa hora?
    boolean existsByMedicoUsuarioIdAndFechaHora(Long medicoId, LocalDateTime fechaHora);

    // Para ver la agenda del mÃ©dico en un rango de fechas
    ...
    // Obtener todas las citas de un paciente ordenadas por fecha (mÃ¡s recientes primero)
